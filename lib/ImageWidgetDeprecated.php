...
class ImageWidgetDeprecated {
	...
	function admin_setup() {
		...
		if ( 'widgets.php' == $pagenow ) {
			...
			wp_enqueue_script( 'sap-image-widget', plugins_url('resources/js/image-widget.deprecated.js', dirname(__FILE__)), array('thickbox'), FALSE, TRUE );
		}
		elseif ( 'media-upload.php' == $pagenow || 'async-upload.php' == $pagenow ) {
			wp_enqueue_script( 'sap-image-widget-fix-uploader', plugins_url('resources/js/image-widget.deprecated.upload-fixer.js', dirname(__FILE__)), array('jquery'), FALSE, TRUE );
	...
	/**
	 * Test context to see if the uploader is being used for the Image In The Widget or for other regular uploads
	 *
	 * @author Modern sap, Inc. (Peter Chester)
	 */
