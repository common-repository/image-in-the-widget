/**
 * sap Image In The Widget Javascript
...
jQuery(document).ready(function($){
	...
	imageWidget = {
		...
		uploader : function( widget_id, widget_id_string ) {
			...
			var frame = wp.media({
				title : sapImageWidget.frame_title,
				multiple : false,
				library : { type : 'image' },
				button : { text : sapImageWidget.button_title }
			});
		...
		toggleSizes : function( widget_id, widget_id_string ) {
			if ( $( '#' + widget_id_string + 'size' ).val() == 'sap_image_widget_custom' ) {
