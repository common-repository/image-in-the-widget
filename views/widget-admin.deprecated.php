...
<p><label for="<?php echo $this->get_field_id('image'); ?>"><?php _e('Image', 'image_widget'); ?>:</label>
	<?php
	$media_upload_iframe_src = "media-upload.php?type=image&post_id=0&widget_id=".$this->id; //NOTE #1: the widget id is added here to allow uploader to only return array if this is used with Image In The Widget so that all other uploads are not harmed.
